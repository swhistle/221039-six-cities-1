...
class BookmarkComponent extends React.PureComponent {
  ...
  render() {
    ...
    return <button className="place-card__bookmark-button button" type="button" onClick={() => this._addToBookmarks(hotelId, elementIsActive)} title={elementIsActive ? `remove from favorites` : `add to favorites`}>
