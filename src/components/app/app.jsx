...
class App extends React.PureComponent {
  ...
  _goToLogIn(e) {
    ...
    this.props.changeAuthorizationRequirement(true);
  }

  render() {
    const {offers, currentCity, isAuthorizationRequired, user} = this.props;
    const userIsLoggedIn = !!user && !!user.avatar_url;

    if (isAuthorizationRequired) {
      return <SignInComponent onSubmitHandler={this._onSubmitHandler}/>;
    }
              ...
              <nav className="header__nav">
                <ul className="header__nav-list">
                  <li className="header__nav-item user">
                    <a className="header__nav-link header__nav-link--profile" href="#" onClick={(e) => this._goToLogIn(e)}>
...
App.propTypes = {
  ...
  isAuthorizationRequired: PropTypes.object,
